<?php require_once(__DIR__ . '/../config/config.php');
    ...
    */
    ...
    $multiple = array(
        'iati_activity_date'                => '@type',
        'iati_contact_info/mailing_address' => 'text',
        'iati_conditions/condition'         => '@type',
        'iati_description'                  => '@type',
        'iati_participating_org'            => '@type',
        'iati_policy_marker'                => '@code',
        'iati_recipient_country'            => '@code',
        'iati_recipient_region'             => '@code',
        'iati_sector'                       => '@code'
    );
    ...
    foreach ($tables as $table => $narrative_column_name) {
        ...
        $results = ORM::for_table($table)
                        ->order_by_asc($parent_column_name)
                        ->find_many();
